...
// Mengubah setiap URL menjadi objek dengan properti 'value' dan 'label',
// dan menambahkan opsi default di awal.
const bugOptions = [
  { value: "", label: "Default" },
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  forms.forEach((form) => {
    form.addEventListener("submit", (e) => {
      ...
      const formType = form.id.split("-")[0] // vless, trojan, or ss
...
function renderPagination(totalPages) {
  ...
  // Page numbers
  const maxVisiblePages = window.innerWidth < 640 ? 3 : 3
